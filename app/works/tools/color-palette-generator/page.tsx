...
export default function ColorPaletteGenerator() {
  ...
  const loadSharedPalettes = useCallback(async () => {
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "Unable to load shared palettes.",
        variant: "destructive",
      })
    } finally {
  ...
  const copyPalette = (colors: string[]) => {
    ...
    toast({
      ...
      description: "All palette colors have been copied.",
    })
  }
  ...
  const sharePalette = async () => {
    if (palette.length < 3) {
      toast({
        title: "Palette not ready",
        description: "Generate a palette before sharing it.",
        variant: "destructive",
      })
      return
    }
    ...
    if (cleanName.length < 2) {
      toast({
        title: "Name required",
        description: "Enter a palette name with at least 2 characters.",
        variant: "destructive",
      })
      return
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Your palette is now visible to everyone.",
      })
    } catch (error) {
      toast({
        title: "Share error",
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <Card className="border-border/70">
          <CardContent className="p-5 sm:p-6">
            <h2 className="mb-2 text-xl font-semibold sm:text-2xl">Why use Color Palette Generator?</h2>
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              Finding the perfect color combination is essential for any UI/UX project. Our tool helps designers and
              developers create visual harmony using professional color theory rules. Whether you need a high-contrast
              complementary scheme or a subtle monochromatic look, our generator provides instant Hex codes for your
              workflow.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/70">
          <CardContent className="grid gap-8 p-4 sm:p-6 lg:grid-cols-[320px_minmax(0,1fr)] lg:p-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="author-name">Author (optional)</Label>
                <Input
                  id="author-name"
                  value={authorName}
              ...
              <Button onClick={sharePalette} disabled={isSharing} className="w-full">
                ...
                {isSharing ? "Publishing..." : "Publish Palette"}
              </Button>
            </div>
